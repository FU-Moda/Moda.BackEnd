...
namespace Moda.BackEnd.Common.Utils
{
    public class SD
    {
        ...
        {
            public static string VERIFY_ACCOUNT = "[MODA]  CHÀO MỪNG BẠN ĐẾN VỚI MODA. VUI LÒNG XÁC MINH TÀI KHOẢN";
            public static string WELCOME = "[MODA] CHÀO MỪNG BẠN ĐẾN VỚI MODA";
            public static string REMIND_PAYMENT = "[MODA] NHẮC NHỞ THANH TOÁN";
            public static string PASSCODE_FORGOT_PASSWORD = "[MODA] MÃ XÁC THỰC QUÊN MẬT KHẨU";
        }
        public class Regex
        {
