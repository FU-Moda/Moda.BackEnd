...
namespace Moda.BackEnd.Common.Utils
{
  ...
  <body>
    <div class=""container"">
      ...
      <div class=""mainBody"">
        ...
        <p class=""emailBody"">
          You are currently registering an account through <b><i>MODA </i></b>.
        </p>
        <p class=""emailBody"">
        ...
        <p class=""support"">
          Thank you for your interest in the services of <b><i>MODA</i></b
  ...
  <body>
    <div class=""container"">
      ...
      <div class=""mainBody"">
        ...
        <p class=""emailBody"">
          You are in the process of completing contract procedures through <b><i>MODA</i></b>.
        </p>
        <p class=""emailBody"">
          Below is your OTP information:
          <b><i> " + body + @"</i></b>
  ...
  <body>
    <div class=""container"">
      ...
      <div class=""mainBody"">
        ...
        <p class=""emailBody"">
         You have accidentally forgotten your password through <b><i>MODA Travel </i></b>.
        </p>
        <p class=""emailBody"">
          Below is your OTP information:
          <b><i> " + body + @"</i></b>
        ...
        <p class=""support"">
          Thank you for your interest in the services of <b><i>MODA Travel</i></b
          >, for any inquiries, please contact
          <u><i>qk.backend@gmail.com</i></u> for support
        </p>
        <div class=""signature"">
  ...
  <body>
    <div class=""container"">
      ...
      <div class=""mainBody"">
        ...
        <p class=""emailBody"">
         Tài khoản hướng dẫn viên của bạn đã được tọ thành công <b><i>MODA Travel </i></b>.
        </p>
        <p class=""emailBody"">
  ...
  <body>
    <div class=""container"">
      ...
      <div class=""mainBody"">
        ...
        <p class=""emailBody"">
         Your quote request has been completed at <b><i>MODA Travel </i></b>.
        </p>
        <p class=""emailBody"">
